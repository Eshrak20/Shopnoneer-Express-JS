...
const getCapitalWallet = () => __awaiter(void 0, void 0, void 0, function* () {
    const wallet = yield capital_model_1.CapitalModel.find({});
    return {
        data: wallet,
    };
});
const getAllWallet = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const baseQuery = wallet_model_1.WalletModel.find({});
