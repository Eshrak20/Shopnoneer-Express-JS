...
exports.WalletAddMoneyZodSchema = exports.WalletTransferZodSchema = exports.WalletBalanceWithdrawZodSchema = exports.WalletBalanceAddZodSchema = void 0;
...
exports.WalletAddMoneyZodSchema = zod_1.z.object({
    balance: zod_1.z.number().nonnegative().default(0).optional(),
    status: zod_1.z.enum(["BLOCKED", "ACTIVE"]).optional(),
});
