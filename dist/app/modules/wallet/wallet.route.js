...
router.get("/capital-wallet", (0, checkAuth_1.checkAuth)(user_interface_1.Role.ADMIN), wallet_controller_1.WalletControllers.getCapitalWallet);
...
router.patch("/:id", (0, validateRequest_1.validateRequest)(wallet_validation_1.WalletAddMoneyZodSchema), (0, checkAuth_1.checkAuth)(user_interface_1.Role.ADMIN), wallet_controller_1.WalletControllers.updateWallet);
