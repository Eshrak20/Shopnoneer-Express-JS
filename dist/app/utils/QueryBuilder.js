...
class QueryBuilder {
    ...
    filter() {
        ...
        const finalFilter = Object.assign({}, this.modelQuery.getQuery());
        if (filter.type)
    ...
    search(searchableField) {
        var _a, _b, _c;
        const searchTerm = ((_a = this.query) === null || _a === void 0 ? void 0 : _a.searchTerm) || ((_b = this.query) === null || _b === void 0 ? void 0 : _b.email) || ((_c = this.query) === null || _c === void 0 ? void 0 : _c.phone) || "";
        if (!searchTerm)
            return this;
        const searchQuery = {
